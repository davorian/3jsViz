...
const DemoControls = ({ 
  ...
  return (
    <div className="demo-controls" style={{ margin: 0, padding: 0, minHeight: '500px', color: 'white' }}>
      ...
      <div className="demo-navigation" style={{ marginTop: 0, paddingTop: 0 }}>
      ...
      >
        ...
        {(activeDemo === 'organic' || activeDemo === 'parametric_spiral_1' || activeDemo === 'parametric_spiral_2' || activeDemo === 'lines_sphere') && (
          <div className="control-group" style={{ marginBottom: '15px' }}>
            <label style={{ 
              color: '#d3b166', 
              fontSize: '0.9rem', 
